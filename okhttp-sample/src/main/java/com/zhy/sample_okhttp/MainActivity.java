...
public class MainActivity extends AppCompatActivity
{
    ...
    public void getHtml(View view)
    {
        ...
        url="http://192.168.0.105:8080/web_home/static/api/news/categories.json";
        OkHttpUtils
                .get()
                .url(url)
                .id(100)
...
//        url =3.125.219.144:8443/mobileConnect/MobileConnect/authLogin.action?systemid=100009&mobile=13260284063&pipe=2&reqtime=1422986580048&ispin=2";
    ...
    {
        String url = "http://192.168.0.105:8080/web_home/%E5%91%A8%E6%9D%B0%E4%BC%A6%20-%20%E5%91%8A%E7%99%BD%E6%B0%94%E7%90%83.mp3";
        OkHttpUtils//
                .get()//
                .url(url)//
                .build()//
                .execute(new FileCallBack(Environment.getExternalStorageDirectory().getAbsolutePath(), "yellow.mp3")//
                {
